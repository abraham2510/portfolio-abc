...
const Project = () => {
    return (
        <>
            <main>
                <div className="w-[90%] md:w-[80%] mx-auto mt-40" id="projects">
                    <div className="max-w-3xl">
                        <p className="text-[#FFEB00] fade-up">MY PROJECTS</p>
                        <h1 className="font-[800] leading-[72px] text-[62px] fade-in">
                            Some Things I Built
                        </h1>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-32 items-center">
                        <div className="lg:order-2 relative group">
                            ...
                            >
                                <img
                                    className="h-[350px] w-full object-cover transition-transform duration-300 group-hover:scale-105"
                                    src="https://ik.imagekit.io/c2zxrxqp6/portfolio-assets/course.jpg?updatedAt=1744095019110"
                                    alt="course"
                                />
                            </a>
                        </div>
                        <div className="lg:order-1 space-y-6">
                            ...
                            <h1 className="font-[800] text-[40px] leading-tight">
                                Course and Banking Management System
                            </h1>
                            <p className="text-slate-300 leading-7">
                                This Spring Boot project is a Course and Banking Management System
                                that provides a RESTful API to manage course-related data, user
                                accounts, and transaction histories. It allows users to add,
                                retrieve, update, and delete course details, apply filters based on
                                price and offers, and search courses by name or stream.
                            </p>
                            <div className="pt-4">
                                <a
                                    href="https://github.com/abraham2510/Course-and-Banking-Management-System"
